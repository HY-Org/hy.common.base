...
mvn install:install-file -Dfile=hy.common.base.jar                              -DpomFile=./src/main/resources/META-INF/maven/cn.openapis/hy.common.base/pom.xml
mvn install:install-file -Dfile=hy.common.base-sources.jar -Dclassifier=sources -DpomFile=./src/main/resources/META-INF/maven/cn.openapis/hy.common.base/pom.xml
