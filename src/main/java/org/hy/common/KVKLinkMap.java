...
/**
 * 互联互通Map的简单实现（有顺序的） -- 即可以像普通Map一样用Key找到Value。也可以用Value找到指向它的【惟一的Key对象】。
 * 
 ...
 */
public class KVKLinkMap<K ,V> extends LinkedHashMap<K ,V> implements Map<K ,V>
{
    
    private static final long serialVersionUID = -2537325931387811734L;
