...
public final class Lunar
{
    ...
    private final static String [] $CN_Ten    = {"初" ,"十" ,"廿" ,"三"};

    private final static String [] $CN_Nums   = {"一" ,"二" ,"三" ,"四" ,"五" ,"六" ,"七" ,"八" ,"九" ,"十" ,"十一" ,"十二"};
    
    private final static String [] $CN_Gan    = {"甲" ,"乙" ,"丙" ,"丁" ,"戊" ,"己" ,"庚" ,"辛" ,"壬" ,"癸"};
    
    private final static String [] $CN_Zhi    = {"子" ,"丑" ,"寅" ,"卯" ,"辰" ,"巳" ,"午" ,"未" ,"申" ,"酉" ,"戌" ,"亥"};
    
    private final static String [] $CN_Animal = {"鼠" ,"牛" ,"虎" ,"兔" ,"龙" ,"蛇" ,"马" ,"羊" ,"猴" ,"鸡" ,"狗" ,"猪"};

    private final static long   [] $CN_Lunar  = {0x04bd8 ,0x04ae0 ,0x0a570 ,0x054d5 ,0x0d260 
    ...
    {
        return (int) ($CN_Lunar[y - 1900] & 0xf);
    }
    ...
    {
        if ( ($CN_Lunar[y - 1900] & (0x10000 >> m)) == 0 )
        {
            return 29;
        }
        else
    ...
    {
        return ($CN_Gan[num % 10] + $CN_Zhi[num % 12]);
    }
    ...
    private static String getChinaDayString(int day)
    {
        ...
        if ( day == 10 )
        {
            return $CN_Ten[0] + $CN_Ten[1];
        }
        else
        {
            return $CN_Ten[day / 10] + $CN_Nums[n];
        }
    }
    ...
    private static Date getBaseDate()
    {
        if ( $BaseDate == null )
        {
            $BaseDate = new Date("1900-01-31 00:00:00");
        }
    ...
    public Lunar(Date i_Date)
    {
        ...
        // 求出和1900年1月31日相差的天数
        int offset = (int) ((i_Date.getTime() - getBaseDate().getTime()) / 86400000L);
        dayCyl = offset + 40;
        monCyl = 14;
        // 用offset减去每农历年的天数
        // 计算当天是农历第几天
