...
public final class Date extends java.util.Date
{
	...
	public boolean equals(Object i_Other)
	{
		...
		else if ( i_Other instanceof java.sql.Date )
		{
			return this.equals(new Date((java.sql.Date)i_Other));
		}
		else if ( i_Other instanceof java.sql.Timestamp )
		{
			return this.equals(new Date((java.sql.Timestamp)i_Other));
		}
